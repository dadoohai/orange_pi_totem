...
TOTEM_PLAYER_STATUS_MPV_WATCHDOG_INTERVAL_SEC="${TOTEM_PLAYER_STATUS_MPV_WATCHDOG_INTERVAL_SEC:-1}"
TOTEM_PLAYER_STATUS_MPV_WATCHDOG_MAX_MISMATCH_SEC="${TOTEM_PLAYER_STATUS_MPV_WATCHDOG_MAX_MISMATCH_SEC:-6}"
TOTEM_PLAYER_STATUS_MPV_WATCHDOG_MIN_ADVANCES="${TOTEM_PLAYER_STATUS_MPV_WATCHDOG_MIN_ADVANCES:-2}"
TOTEM_PLAYER_STATUS_MPV_WATCHDOG_POST_REALIGN_WAIT_SEC="${TOTEM_PLAYER_STATUS_MPV_WATCHDOG_POST_REALIGN_WAIT_SEC:-4}"
...
TOTEM_PLAYER_STATUS_MPV_WATCHDOG_MAX_MISMATCH_SEC="$(positive_integer_or_default "$TOTEM_PLAYER_STATUS_MPV_WATCHDOG_MAX_MISMATCH_SEC" 6)"
...
TOTEM_PLAYER_STATUS_MPV_WATCHDOG_POST_REALIGN_WAIT_SEC="$(positive_integer_or_default "$TOTEM_PLAYER_STATUS_MPV_WATCHDOG_POST_REALIGN_WAIT_SEC" 4)"
...
start_player_health_watchdog() {
  ...
  /usr/bin/python3 "$TOTEM_PLAYER_STATUS_MPV_WATCHDOG" \
    ...
    --post-realign-wait-sec "$TOTEM_PLAYER_STATUS_MPV_WATCHDOG_POST_REALIGN_WAIT_SEC" &
  PLAYER_HEALTH_WATCHDOG_PID="$!"
