...
TAG = "c18-hwdecode-lab-1r"   # 1r = 1q + multi-segment deep-health gate + persistent-trial abort cleanup.
VERSION = "c18.image-lab.1r"
...
MARKER = "/etc/dadooh/c18-hwdecode-lab-1r-image"
...
def main():
    ...
    manifest = {
        "round": "C18.IMAGE-LAB.1r", "image_tag": TAG, "image_version": VERSION,
