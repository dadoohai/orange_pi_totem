...
PY_COMPILE_TARGETS = (
    ...
    "scripts/board/totem_qr_pairing_client.py",
    "scripts/board/totem_settings_production_apply_policy.py",
    ...
    "scripts/board/c18_display_status_collect.py",
    "scripts/board/c18_display_profile_baseline_collect.py",
    ...
    "scripts/board/c18_homologation_pilot_preflight_collect.py",
    "scripts/board/c18_player_runtime_candidate_health.py",
    "scripts/board/c18_player_runtime_h2_powerloss_preflight_collect.py",
    "scripts/board/c18_totem_core_production_timer_collect.py",
    "scripts/board/c18_player_runtime_production_autopull_collect.py",
    "scripts/board/c22_rapid_media_fault_trial.py",
    ...
    "scripts/qa/c18_player_runtime_production_autopull_evidence_gate.py",
    "scripts/qa/c18_player_runtime_exact_target_publish_test.py",
    ...
    "scripts/qa/c18_board_readonly_diagnostics_evidence_gate.py",
    ...
    "scripts/qa/c18_ota_pre_soak_scale_governance_gate.py",
    ...
    "scripts/qa/c18_player_runtime_thaw_decision_gate.py",
    "scripts/qa/c18_playback_soak_exception_gate.py",
    "scripts/qa/c18_player_runtime_public_thaw_activation_gate.py",
    "scripts/qa/c18_player_runtime_stable_decision_draft_build.py",
    "scripts/qa/c18_server_side_publish_governance_gate.py",
    "scripts/qa/c18_server_side_publish_asset_collect.py",
    "scripts/qa/c18_server_side_publish_evidence_build.py",
    "scripts/qa/c18_totem_core_publish_asset_list.py",
    ...
    "scripts/qa/c18_player_runtime_powerloss_evidence_manifest_build.py",
    "scripts/qa/c18_player_runtime_powerloss_matrix_plan.py",
    "scripts/qa/c18_player_runtime_powerloss_operator_runbook_build.py",
    "scripts/qa/c18_player_runtime_h2_powerloss_preflight_gate.py",
...
TEST_COMMANDS = (
    ...
    ("c18_display_status_collect_self_test", ["python3", "scripts/board/c18_display_status_collect.py", "--self-test"]),
    ...
    ("c22_rapid_media_fault_trial", ["python3", "scripts/qa/c22_rapid_media_fault_trial_test.py"]),
    ("c18_player_runtime_release_gate", ["python3", "scripts/qa/c18_player_runtime_release_gate.py", "--self-test"]),
    ("c18_player_runtime_production_autopull_authorization_build", ["python3", "scripts/qa/c18_player_runtime_production_autopull_authorization_build.py", "--self-test"]),
    ("c18_player_runtime_production_autopull_authorization_gate", ["python3", "scripts/qa/c18_player_runtime_production_autopull_authorization_gate.py", "--self-test"]),
    ("c18_player_runtime_production_autopull_evidence_gate", ["python3", "scripts/qa/c18_player_runtime_production_autopull_evidence_gate.py", "--self-test"]),
    ("c18_player_runtime_exact_target_publish", ["python3", "scripts/qa/c18_player_runtime_exact_target_publish_test.py"]),
    ("c18_player_runtime_github_lab_apply", ["python3", "scripts/qa/c18_player_runtime_github_lab_apply.py", "--self-test"]),
    ("c18_stable_promotion_gate", ["python3", "scripts/qa/c18_stable_promotion_gate.py", "--self-test"]),
    ("c18_totem_core_stable_promotion_gate", ["python3", "scripts/qa/c18_totem_core_stable_promotion_gate.py", "--self-test"]),
    ("c18_totem_core_production_timer_evidence_gate", ["python3", "scripts/qa/c18_totem_core_production_timer_evidence_gate.py", "--self-test"]),
    ("c18_player_runtime_thaw_decision_gate", ["python3", "scripts/qa/c18_player_runtime_thaw_decision_gate.py", "--self-test"]),
    ("c18_playback_soak_exception_gate", ["python3", "scripts/qa/c18_playback_soak_exception_gate.py", "--self-test"]),
    ("c18_player_runtime_public_thaw_activation_gate", ["python3", "scripts/qa/c18_player_runtime_public_thaw_activation_gate.py", "--self-test"]),
    ("c18_player_runtime_stable_decision_draft_build", ["python3", "scripts/qa/c18_player_runtime_stable_decision_draft_build.py", "--self-test"]),
    ("c18_server_side_publish_governance_gate", ["python3", "scripts/qa/c18_server_side_publish_governance_gate.py", "--self-test"]),
    ("c18_server_side_publish_asset_collect", ["python3", "scripts/qa/c18_server_side_publish_asset_collect.py", "--self-test"]),
    ("c18_server_side_publish_evidence_build", ["python3", "scripts/qa/c18_server_side_publish_evidence_build.py", "--self-test"]),
    ("c18_totem_core_publish_asset_list", ["python3", "scripts/qa/c18_totem_core_publish_asset_list.py", "--self-test"]),
    ...
    ("c18_player_runtime_powerloss_evidence_manifest_build_self_test", ["python3", "scripts/qa/c18_player_runtime_powerloss_evidence_manifest_build.py", "--self-test"]),
    ("c18_player_runtime_powerloss_matrix_plan_self_test", ["python3", "scripts/qa/c18_player_runtime_powerloss_matrix_plan.py", "--self-test"]),
    ("c18_player_runtime_powerloss_operator_runbook_build_self_test", ["python3", "scripts/qa/c18_player_runtime_powerloss_operator_runbook_build.py", "--self-test"]),
    ("c18_player_runtime_h2_powerloss_preflight_gate_self_test", ["python3", "scripts/qa/c18_player_runtime_h2_powerloss_preflight_gate.py", "--self-test"]),
    ...
    ("c18_board_readonly_diagnostics_evidence_gate", ["python3", "scripts/qa/c18_board_readonly_diagnostics_evidence_gate.py", "--self-test"]),
    ("c18_ota_macro_governance_gate", ["python3", "scripts/qa/c18_ota_macro_governance_gate.py", "--self-test"]),
    ("c18_ota_operational_resume_gate", ["python3", "scripts/qa/c18_ota_operational_resume_gate.py", "--self-test"]),
    ("c18_ota_pre_soak_scale_governance_gate", ["python3", "scripts/qa/c18_ota_pre_soak_scale_governance_gate.py", "--self-test"]),
    ("c18_homologation_pilot_preflight_collect", ["python3", "scripts/board/c18_homologation_pilot_preflight_collect.py", "--self-test"]),
    ("c18_totem_core_production_timer_collect", ["python3", "scripts/board/c18_totem_core_production_timer_collect.py", "--self-test"]),
    ("c18_player_runtime_production_autopull_collect", ["python3", "scripts/board/c18_player_runtime_production_autopull_collect.py", "--self-test"]),
...
TEST_TIMEOUTS = {
    ...
    # The 54 fail-closed production auto-pull evidence vectors now take about
...
BASH_SYNTAX_TARGETS = (
    ...
    "scripts/deploy/publish_player_runtime_github_release.sh",
    "scripts/deploy/publish_player_runtime_exact_target_release.sh",
