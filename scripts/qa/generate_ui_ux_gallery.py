    ...
    for visible in (False, True):
        add_screen(
            ...
            ScreenSpec(
                ...
                primary_action="Enter OK",
                secondary_action="F2/V alterna | Ctrl+B volta | Ctrl+U limpa",
                ...
                body_items=["Oculta por padrao.", "F2 ou V mostra.", "Nao aparece em logs."],
                footer="Enter OK | F2/V oculta | Ctrl+B volta | Ctrl+U limpa" if visible else "Enter OK | F2/V mostra | Ctrl+B volta | Ctrl+U limpa",
                option_text=[],
                back_applicable=True,
                error_recovery_available=True,
            ),
