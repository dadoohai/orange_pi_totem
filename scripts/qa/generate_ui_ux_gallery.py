...
def add_wizard_screens(specs: list[ScreenSpec], gallery_dir: pathlib.Path) -> None:
    ...
    add_screen(
        ...
        gallery_dir,
        ScreenSpec(
            screen_id="wizard.orientation.step_focus",
            journey="wizard",
            screen_type="wizard",
            orientation="landscape",
            function="Mostrar foco unico no menu superior do wizard.",
            operator_task="Usar esquerda/direita para escolher etapa.",
            primary_action="Enter abre",
            secondary_action="Esc volta",
            message_main="Orientacao da tela",
            system_state="wizard_step_focus",
            next_step_expected="Abrir etapa focada ou voltar aos itens.",
            confusion_risk="low",
            dependencies=["keyboard", "wizard SVG renderer"],
            dynamic_feedback_needed=True,
            error_state_needed=False,
            ...
            title="Orientacao da tela",
            subtitle="Escolha como o totem esta instalado.",
            body_items=["Foco no topo.", "Itens mantem selecao.", "Sem menu modal."],
    ...
    for screen_id, title, subtitle, footer, field_label, value_hint, field_note, items in (
        ...
        (
            ...
            "Enter corrige | Cima menu | Esc volta",
            "",
            "",
            "",
        ...
        add_screen(
            ...
            ScreenSpec(
                ...
                secondary_action=(
                    "Esc cancela"
                    if is_error
                        else ("Cima menu | Esc volta" if screen_id in {"wizard.review", "wizard.review_pending"} else ("Esc volta" if screen_id == "wizard.environment" else "Nenhuma."))
                ),
                message_main=title,
...
def add_c16_2_state_screens(specs: list[ScreenSpec], gallery_dir: pathlib.Path) -> None:
    cases: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "message_main": "Orientacao da tela",
            "system_state": "wizard_orientation",
            "next_step_expected": "Wi-Fi.",
            "confusion_risk": "low",
            "title": "Orientacao da tela",
            "subtitle": "Escolha como o totem esta instalado.",
            "items": ["Paisagem", "Retrato", "Pode voltar antes de salvar."],
            "footer": "Cima menu | Baixo escolhe | Enter confirma | Esc cancela",
            "accent": "#06b6d4",
            "back_applicable": True,
        },
        {
            ...
            "journey": "C",
            "function": "Escolher caminho de Wi-Fi.",
