...
DEFAULT_MACRO_SUMMARY = (
    REPO_ROOT
    / "docs/evidence/c18-update-validation/20260617T021956Z-current-macro-governance-fa2f0a6/macro-governance.json"
)
...
def evaluate_operational_resume_default(now_utc: str, *, allow_dirty_repo: bool = False) -> dict[str, Any]:
    ...
    if "20260617T021956Z-current-macro-governance-fa2f0a6" not in str(macro.get("summary_path")):
