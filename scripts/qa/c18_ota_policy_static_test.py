...
class C18OtaPolicyStaticTest(unittest.TestCase):
    ...
    def test_image_embed_has_explicit_production_profile(self) -> None:
        ...
        expected_core_version = "c26.12-local-recovery-20260719-2b67570-final-actions"
        expected_core_tag = f"totem-core-{expected_core_version}"
        expected_core_sha = "389ba30dd19ba4c7b7d499ca808b925f70ef8941b2c3a91d15a60c4e408c4256"
        ...
        self.assertEqual(mod.TOTEM_CORE_CREATED_AT_UTC, "2026-07-19T00:32:24Z")
        self.assertEqual(
            mod.TOTEM_CORE_SOURCE_COMMIT,
            "2b67570b91eae9573c5fa94dad3166b35b0086ce",
        )
        self.assertEqual(
            mod.TOTEM_CORE_PREVIOUS_VERSION,
            "c26.11-local-recovery-20260719-24797ad-transport-complete-actions",
        )
        self.assertEqual(
            mod.TOTEM_CORE_PREVIOUS_PAYLOAD_SHA256,
            "5ca814e3122bdd277d40b15ee18b9356a8ea55719f09692b1372037896b1162d",
        )
        ...
        self.assertEqual(
            release_provenance["semantic_gate_schema"],
            "dadooh.c26.totem_core_payload_semantic_gate.v1",
        )
        ...
        self.assertEqual(
            previous_release_provenance["semantic_gate_schema"],
            "dadooh.c26.totem_core_payload_semantic_gate.v1",
        )
    ...
    def test_c18_image_deriver_has_explicit_production_path(self) -> None:
        ...
        self.assertIn("production candidate identity must match the pinned release", derive)
        ...
        self.assertIn('PRODUCTION_TAG = "c18-hwdecode-prod-19-c26"', derive)
        self.assertIn('PRODUCTION_VERSION = "c18.image-prod.19-c26"', derive)
        ...
        self.assertIn('"totem_core_c26_12_current_c26_11_previous_embedded"', derive)
        ...
        self.assertIn('f"{PRODUCTION_PREDECESSOR_TAG} (board-validated predecessor', derive)
        playback_summary_at_bound_commit = subprocess.run(
            [
                "git",
                "show",
                "c075a5572148ed25aed000a22202f918c4157fda:scripts/board/c18_playback_health_summary.py",
            ],
            cwd=REPO_ROOT,
        ...
        self.assertEqual(
            playback_summary_at_bound_commit,
            (REPO_ROOT / "scripts/board/c18_playback_health_summary.py").read_bytes(),
        )
        ...
        self.assertIn("production_lab_firstboot_artifacts_absent", derive)
    ...
    def test_c18_production_image_credential_policy_is_fail_closed(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            module.validate_candidate_identity(
                "c18-hwdecode-prod-19-c26",
                "c18.image-prod.19-c26",
                "/etc/dadooh/c18-hwdecode-prod-19-c26-image",
