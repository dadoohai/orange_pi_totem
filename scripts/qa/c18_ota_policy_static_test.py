...
class C18OtaPolicyStaticTest(unittest.TestCase):
    ...
    def test_totem_core_production_timer_validation_is_wired(self) -> None:
        ...
        self.assertIn("test_manual_service_event_after_old_timer_denies", gate)
        self.assertIn("test_service_event_before_timer_trigger_denies", gate)
        ...
        self.assertIn("c18-hwdecode-prod-19-c26", runbook)
        self.assertIn("c18.image-prod.19-c26", runbook)
        self.assertIn("totem-core-c26.17-product-stable-20260719T193306Z-0e02019-actions", runbook)
        self.assertNotIn("c18-hwdecode-prod-14", runbook)
        self.assertNotIn("c21.12-prod14-stable-alignment", runbook)
