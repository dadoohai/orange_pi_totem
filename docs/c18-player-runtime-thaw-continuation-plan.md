...
| power-loss/soak | P0 seletivo fisico completo para piloto; semantica 17/17 implementada no gate; planner H2 `20260617T020912Z-h2-powerloss-matrix-plan-custom-setup-c16fb3e` registra 5/17 cobertos, 12 faltantes e instrucoes manuais para checkpoints de setup customizado sem reivindicar evidencia; runbook `20260617T073519Z-h2-powerloss-operator-runbook-manifest-helper-c16fb3e` bloqueia setup customizado sem comandos/instrucoes, recusa misturar evidencia local reaproveitada, materializa o manifest local exigido pelo evidence gate e fixa o marker de imagem esperado no preflight; H2 gate ainda vermelho por lacuna de evidencia fisica e soak | 12 checkpoints fisicos restantes da matriz 17/17 e soak 24h |
