...
separada. A etapa atual e essa ultima: ativacao/publicacao publica de
`player-runtime`, sem inferir auto-pull, sem usar publisher de `totem-core` e
sem converter automaticamente o pacote homologation em manifest stable.
