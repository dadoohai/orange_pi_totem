...
milestone was fixed in the C15.1.5 repo changes and then applied on-device when
SSH returned. Remaining visual polish is tracked as a future PDCA effort for the
