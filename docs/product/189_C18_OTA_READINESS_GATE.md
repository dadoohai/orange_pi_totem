...
| Proximo gate H2 | Primeiro fechar a estrategia do rollback para `m6-a`/runtime antigo sem mascarar evidencia por watchdog. Depois completar os 2 checkpoints restantes de power-loss/torn-write, rodar soak/endurance 24h, promocao stable e decisao final antes de qualquer caminho `stable`/producao. |
