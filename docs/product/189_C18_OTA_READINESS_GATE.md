...
| Gate macro pre-H2 | `scripts/qa/c18_ota_macro_governance_gate.py` agrega H1, pilot readiness, H2 vermelho e diagnostico read-only em snapshot governado; nao substitui H2, nao reabre janela expirada e nao autoriza producao. O snapshot corrente pos-P0 esta em `docs/evidence/c18-update-validation/20260618T043100Z-current-macro-governance-after-pilot-p0-9bebaf1/` e aponta para o pilot gate final; o snapshot antigo permanece historico. |
