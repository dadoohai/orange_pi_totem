...
| Power-loss fisico | Parcialmente provado em laboratorio na imagem `1w`: `after_marker_written`, `after_previous_symlink`, `after_current_symlink`, `rollback_after_current_to_previous` e `rollback_after_previous_removed` |
