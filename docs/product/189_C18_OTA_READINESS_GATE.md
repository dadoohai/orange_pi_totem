...
| Rastreabilidade dos gates | Release gate decisivo git-guarda os diretorios coldboot/data; H2 readiness exige arvore limpa e inputs rastreados, incluindo power-loss, H1 summary, server-side release dir, trust-anchor/key publica, stable evidence, soak e decisao operador quando informados |
