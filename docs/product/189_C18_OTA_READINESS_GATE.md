...
| Proximo gate H2 | Com `rollback_after_identify_links` verde na topologia bridge, completar o ultimo checkpoint fisico restante (`rollback_after_current_unlinked`, fallback de imagem). Depois rodar soak/endurance 24h, promocao stable e decisao final antes de qualquer caminho `stable`/producao. |
