...
| Rastreabilidade dos gates | Release gate decisivo git-guarda os diretorios coldboot/data; H1 atual `20260612T194911Z-1x-h1-decisive-traceability-refresh-7e40e80`; para o alvo `9bebaf1`, H2 readiness atual esta em `docs/evidence/c18-update-validation/20260618T065117Z-current-h2-readiness-head-909a625-9bebaf1/h2-readiness.json` e continua vermelho somente por power-loss 17/17, soak 24h, stable promotion e decisao formal de thaw |
