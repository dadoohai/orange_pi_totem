...
| Rastreabilidade dos gates | Release gate decisivo git-guarda os diretorios coldboot/data; H1 atual `20260612T194911Z-1x-h1-decisive-traceability-refresh-7e40e80`; H2 readiness exige arvore limpa e inputs rastreados, snapshot atual `20260617T003916Z-current-h2-readiness-c16fb3e` |
...
| Retomada operacional | `scripts/qa/c18_ota_operational_resume_gate.py` precisa ficar verde antes de qualquer nova execucao na placa; hoje o snapshot antigo deve bloquear por janela expirada/preflight velho ate haver autorizacao e preflight frescos |
