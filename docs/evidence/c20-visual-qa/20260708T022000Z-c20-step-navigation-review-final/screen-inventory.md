...
| wizard.step_menu | Navegar entre etapas sem salvar estado incompleto. | Enter abre | Esc volta | low | yes |
...
| wizard.environment | Coletar identificador de ambiente. | Enter | Tab etapas | Esc volta | low | yes |
| wizard.review | Revisar escolhas antes de gravar. | Enter | Tab etapas | Esc volta | medium | yes |
| wizard.review_pending | Bloquear conclusao enquanto faltam etapas obrigatorias. | Enter | Tab etapas | Esc volta | medium | yes |
