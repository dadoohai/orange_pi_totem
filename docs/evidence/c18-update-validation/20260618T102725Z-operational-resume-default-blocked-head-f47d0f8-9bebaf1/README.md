# C18 operational resume default blocked at f47d0f8 - 9bebaf1

Purpose: re-run `scripts/qa/c18_ota_operational_resume_gate.py` against the
current macro-governance snapshot without supplying a fresh authorization or
fresh board preflight.
