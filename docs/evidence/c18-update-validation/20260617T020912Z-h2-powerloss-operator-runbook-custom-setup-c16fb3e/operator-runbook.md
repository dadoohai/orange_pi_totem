...
ssh <board-host> \
  "cd '/data/c18-p0-bundle-a0dcb13fd78d' && \
   ...
   python3 -B /tmp/c18_player_runtime_h2_powerloss_preflight_collect.py \
     ...
     --json" \
  > 'docs/evidence/c18-update-validation/<utc>-h2-powerloss-preflight-c16fb3e/board-preflight.json'
ssh <board-host> \
...
python3 scripts/qa/c18_player_runtime_h2_powerloss_preflight_gate.py \
  --preflight 'docs/evidence/c18-update-validation/<utc>-h2-powerloss-preflight-c16fb3e/board-preflight.json' \
  --matrix-plan 'docs/evidence/c18-update-validation/20260617T020912Z-h2-powerloss-matrix-plan-custom-setup-c16fb3e/powerloss-matrix-plan.json' \
