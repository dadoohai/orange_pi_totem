...
Fresh read-only board preflight collected from `root@192.168.18.131`
before any new H2 physical power-loss checkpoint execution.
...
- collected from board at `2026-06-17T06:10:38Z`;
- target package:
...
- evidence root for pending checkpoints is not contaminated.
