# C18 readiness after rollback_current_to_previous P0

Snapshot after collecting the second selective P0 physical power-loss checkpoint.

Pilot/homologation status:

- observed P0 checkpoints: `after_current_symlink`, `rollback_after_current_to_previous`
- remaining P0 checkpoints: `rollback_after_previous_removed`, `rollback_after_quarantine`, `rollback_after_state_success`
