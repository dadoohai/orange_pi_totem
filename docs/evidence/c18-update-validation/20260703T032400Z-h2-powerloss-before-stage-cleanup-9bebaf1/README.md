# C18 H2 power-loss checkpoint: before_stage_cleanup

Physical power was cut after the player-runtime apply operation reached the stage-cleanup boundary for `c18.player-runtime-homolog-20260617-mpv-stuck-fix-9bebaf1`.
