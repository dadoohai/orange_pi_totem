...
ssh root@192.168.18.131 \
  "cd '/data/c18-powerloss-bundle-3eb06f1' && \
   ...
   python3 -B /tmp/c18_player_runtime_h2_powerloss_preflight_collect.py \
     ...
     --json" \
  > 'docs/evidence/c18-update-validation/<fresh-utc>-h2-powerloss-preflight-9bebaf1/board-preflight.json'
ssh root@192.168.18.131 \
...
python3 scripts/qa/c18_player_runtime_h2_powerloss_preflight_gate.py \
  --preflight 'docs/evidence/c18-update-validation/<fresh-utc>-h2-powerloss-preflight-9bebaf1/board-preflight.json' \
  --matrix-plan 'docs/evidence/c18-update-validation/20260618T080037Z-h2-powerloss-matrix-plan-5of17-9bebaf1/powerloss-matrix-plan.json' \
