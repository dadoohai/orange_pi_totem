...
| wifi_open_retry_fake | open_success_keeps_product_access_inconclusive | pass |  |
| wifi_open_retry_fake | open_result_reaches_completion | pass |  |
| wifi_open_retry_fake | networkmanager_not_called_by_replay | pass |  |
| wifi_state_matrix_fake | success_online_is_consistent | pass |  |
| wifi_state_matrix_fake | success_limited_is_consistent | pass |  |
| wifi_state_matrix_fake | success_offline_is_consistent | pass |  |
| wifi_state_matrix_fake | success_unknown_is_consistent | pass |  |
| wifi_state_matrix_fake | failure_auth_is_specific | pass |  |
| wifi_state_matrix_fake | failure_timeout_is_specific | pass |  |
| wifi_state_matrix_fake | failure_missing_is_specific | pass |  |
| wifi_state_matrix_fake | failure_signal_is_specific | pass |  |
| wifi_state_matrix_fake | failure_ip_is_specific | pass |  |
| wifi_state_matrix_fake | failure_device_is_specific | pass |  |
| wifi_state_matrix_fake | failure_generic_open_is_specific | pass |  |
| wifi_state_matrix_fake | cached_list_is_not_fresh | pass |  |
| wifi_state_matrix_fake | connectivity_matrix_is_explicit | pass |  |
| wifi_state_matrix_fake | raw_failure_text_not_rendered | pass |  |
| wifi_state_matrix_fake | networkmanager_not_called_by_replay | pass |  |
